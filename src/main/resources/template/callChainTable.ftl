...
<div class="bs-docs-header" id="content" tabindex="-1">
    <div class="container"><h1>Coswee</h1>
        ...
        <a href="https://github.com/xuqiu/coswee" target="_blank">
                ...
                <div class="row">
                    ...
                    <div>
                        <table class="table sortable table-hover">
                            ...
                            <script>
                                $(function (){
                                    $("#detail_${call_index}").popover({trigger: 'manual',html:true,
                                        title: 'Call From for <b>${call.name}</b><span class="glyphicon glyphicon-remove" style="position: absolute; top: 10px; right: 5px; border: 0"; onclick="closeAllPop();"/>', content: $("#rootTable_${call_index}").html()}).on({
                                        click: function() {
                                            closeAllPop();
                                            $(this).popover('toggle');
                                            sorttable.makeSortable($(".popover-content table")[0]);
                                        }
                                    });
                                });
                            </script>
